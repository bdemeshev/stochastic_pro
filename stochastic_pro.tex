...
\begin{problem}
A company gets fines for non-removal of law violating content according to Poisson process with rate $1$ fine per day. 
Each fine has the size $10^{33}$ roubles. 

What is the probability that the total amount of fines will exceed two undecillion roubles in 1000 days?
\begin{sol}
