...
\begin{enumerate}
  ...
  \item Find conditional expected values $\E(T \mid \cF_J)$, $\E(X_{T-1} \mid \cF_J)$, $\E(X_{T+1} \mid \cF_J)$.
...
\begin{sol}
  \begin{enumerate}
    ...
    \item $\E(T \mid \cF_J) = T$, $\E(X_{T-1} \mid \cF_J) = X_{T-1}$, $\E(X_{T+1} \mid \cF_J) = -1$.
    \item $\E(S_T \mid \cF_J) = S_T$, $\E(S_{T+1} \mid \cF_J) = S_T - 1$, $\E(S_{T+2} \mid \cF_J) = S_T - 1/2$.
  \end{enumerate}
