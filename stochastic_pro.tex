...
\begin{problem}
  ...
  Let $R = \int_0^9 X_t dW_t$.
  \begin{enumerate}
    \item Express $R$ without integrals. 
    \item Find $\E(R)$ and $\Var(R)$.
  \end{enumerate}
  %
  Let $(Y_t) = \int_0^t X_u dW_u$.
  \begin{enumerate}
    \item Express $(Y_t)$ without integrals. 
    \item Find $\E(Y_t)$ and $\Var(Y_t)$.
    \item Find $\Cov(Y_3, Y_9)$ and $\Cov(Y_s, Y_t)$.
...
\begin{problem}
  ...
  \begin{enumerate}
    \item Express $(Y_t)$ without integrals. 
    \item Find $\E(Y_t)$ and $\Var(Y_t)$.
    \item Find $\Cov(Y_2, Y_8)$ and $\Cov(Y_s, Y_t)$.
    \item Is $(Y_t)$ a martingale?
  \end{enumerate}
  \begin{sol}
