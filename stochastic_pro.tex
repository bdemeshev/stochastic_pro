...
\begin{problem}
  ...
  At first stage we remove the middle third from the segment.
  Hence after the first stage we obtain $I_1 = [0; 1/3] \cup [2/3; 1]$.
  At second stage we remove the middle third from every segment.
...
\begin{problem}
  ...
  At first stage we subdivide the triangle into four smaller congruent equilateral triangles and remove the central triangle.
  Hence after the first stage the set $T_1$ that consists of three triangles.
  At second stage we we subdivide every triangle into four smaller congruent equilateral triangles and remove the central triangle.
